...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `RXHL DEVELOPER 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://t.me/ag64462`}}}, { quoted:m})} 
...
previewType: "VIDEO",
thumbnail: rxhlimage,
sourceUrl: `https://t.me/ag64462`,
mediaUrl: `https://t.me/ag64462`
}
},
text: teks
}, {
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Owner\",\"url\":\"https://t.me/ag64462\",\"merchant_url\":\"https://t.me/ag64462\"}"
}
],
"messageParamsJson": ""
}
...
hohe = [
  {
   ...
   buttonParamsJson: JSON.stringify({
      display_text: "",
      url: "https://t.me/ag64462",
      merchant_url: "https://t.me/ag64462"
   })
}
]
ewe = `${menuu}`
...
rxhl.sendMessage(Pe, {text: `Owner\n https://t.me/ag64462`}, {quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
